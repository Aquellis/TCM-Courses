# This script iterates through a given list of TOML files containing Elastic alert data and converts the TOML to JSON format
# then creates a new alert in our Elastic project using the JSON formatted data
